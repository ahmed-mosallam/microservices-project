package com.professional.orderservice.security;
...
import com.professional.orderservice.dto.AuthenticationUser;
...
public class TokenVerificationFilter extends OncePerRequestFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		System.out.println("req url >> " + request.getRequestURI() + " && authorization " + authorizationHeader);
		if(Strings.isNullOrEmpty(authorizationHeader) || !authorizationHeader.startsWith(tokenPrefix))
		  filterChain.doFilter(request, response);
			...
			try {
		     ...
		     System.out.println("order service token claims " + claims);
