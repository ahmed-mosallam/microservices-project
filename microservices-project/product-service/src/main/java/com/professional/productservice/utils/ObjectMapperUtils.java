package com.professional.productservice.utils;
...
public class ObjectMapperUtils<EDTO> {
	...
	public static <T> List<T> jsonArrayToList(String json, Class<T> elementClass) throws IOException, JsonMappingException, JsonProcessingException {
